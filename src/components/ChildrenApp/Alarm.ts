...
export default class Alarm
   ...
   * 외부에서 호출되는 인터페이스이므로 매개ㅂ수를 일반적인 Date 객체로 설정했습니다.
   *
  ...
  loadItems() {
    this.items = [
      { isAM: true, hours: 11, minutes: 20 },
      { isAM: true, hours: 12, minutes: 20 },
      { isAM: false, hours: 1, minutes: 5 },
      { isAM: false, hours: 3, minutes: 5 },
    ]
  }
